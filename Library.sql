...
-- Généré le :  Mar 05 Décembre 2017 à 13:31
...
INSERT INTO `Books` (`id`, `title`, `author`, `category`, `release_date`, `summary`, `availability`, `id_user`) VALUES
...
(1, 'Sylvain Sculier', 8807),
(2, 'Alexia Boulenger', 3006),
(3, 'Geoffrey S', 309),
(4, 'Benoît S', 2003);
